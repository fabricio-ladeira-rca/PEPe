...
<% using (Html.BeginForm("create", "poll")) { %>
    ...
    <p class="date poll">
        ...
        <%= Html.TextBox("poll.startAt", null, new { Class = "date-field text-field" })%>
    </p>
    
    <p class="date poll">
        <label>Data de encerramento:</label>
        <%= Html.TextBox("poll.endAt", null, new { Class = "date-field text-field" })%>
    </p>
	...
	<%= Html.ValidationMessage("answer5.description", "*")%>
