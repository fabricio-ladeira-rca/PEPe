...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<table class="adminlist">
	    ...
	    <% foreach(randon_consorcios_racon_v1.Models.Assembly assembly in (randon_consorcios_racon_v1.Models.Assembly[])ViewData["assemblies"]) { %>
	    <tr>
	        <td><%= assembly.Section.Name %></td>
